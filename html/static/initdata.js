var shouhouTypeMap={};
var shouhouTypeResultStr="";

$(document).ready(function(){
	initData();
});
function initData() {
	//$.ajax({url:"/shouhouType/list?pageNum=1&pageSize=100",success:function(result){
...
function initSelect(type,objId,value) {
